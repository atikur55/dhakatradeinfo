												...
												<tr>
													...
													<td>
					                                    <div class="dropdown">
														    ...
														    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
														        <a class="dropdown-item text-warning" href="#trackModal{{$order->id}}" data-toggle="modal"><i class="flaticon2-edit icon-lg"></i>&nbsp;&nbsp;Track
							                                    </a>
							                                    <a class="dropdown-item text-danger" href="#deleteModal{{$order->id}}" data-toggle="modal"><i class="flaticon2-rubbish-bin-delete-button icon-lg"></i> &nbsp;&nbsp;Invoice
						                                    	</a>
														    </div>
														</div>
													</td>

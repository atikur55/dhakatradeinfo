                        ...
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <ul class="nav nav-bold nav-pills ml-auto">
                                    <li class="nav-item">
                                         <a href="{{route('admin.product.create')}}" class="btn btn-success"><i class="flaticon2-plus-1 icon-lg"></i> Add New Product</a>
                                    </li>
                               </ul>
                            </div>
                        </div>
													...
													<td>
					                                    <div class="dropdown">
														    ...
														    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
														        ...
														        <a class="dropdown-item text-warning" href="{{route('admin.product.edit', ['id' => $product->id])}}"><i class="flaticon2-edit icon-lg"></i>&nbsp;&nbsp;Edit
							                                    </a>
